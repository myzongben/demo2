...
public interface JiyixianMapper {
    ...
    @Insert("INSERT INTO wzb_jiyixian(message,url,create_time,shangxian_time,redmine_no,other)  VALUES (#{message},#{url},#{create_time},#{shangxian_time},#{redmine_no},#{other}) ")
